...
import 'package:task/domain/use_case/get_tasks.dart' as _i678;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.lazySingleton<_i1020.AddTaskUseCase>(() => _i1020.AddTaskUseCase());
    gh.lazySingleton<_i138.DeleteTaskUseCase>(() => _i138.DeleteTaskUseCase());
    gh.lazySingleton<_i678.GetTasksUseCase>(() => _i678.GetTasksUseCase());
    gh.lazySingleton<_i527.UpdateTaskUseCase>(
        () => const _i527.UpdateTaskUseCase());
    gh.factory<_i1048.TaskAddCubit>(
        () => _i1048.TaskAddCubit(gh<_i1020.AddTaskUseCase>()));
    gh.factory<_i338.TaskListCubit>(
        () => _i338.TaskListCubit(gh<_i678.GetTasksUseCase>()));
